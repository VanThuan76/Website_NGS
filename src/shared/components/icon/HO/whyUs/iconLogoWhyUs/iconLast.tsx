      ...
      <defs>
        {open && (
          ...
          >
            ...
            <feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_2236_611' />
            <feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_2236_611' result='shape' />
          </filter>
        )}
      </defs>
    </svg>
