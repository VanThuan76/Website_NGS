...
export default function IconMid({ gradientColor = '', open, ...rest }: IconMidProps) {
  return (
    <svg width='350' height='300' viewBox='0 0 211 189' xmlns='http://www.w3.org/2000/svg' fill='none' {...rest}>
      <path
        fill='currentColor'
        fillRule='evenodd'
        clipRule='evenodd'
