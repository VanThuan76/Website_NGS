...
import { ICategories } from 'src/shared/schemas/models/ICategory';

type Props = {
  onSubmit: (value: Partial<ICategories>) => void;
  isLoading?: boolean;
  defaultValue?: Partial<ICategories>;
  onBack?: () => void;
};
...
export default function FormCategory({ onSubmit, isLoading, defaultValue, onBack }: Props) {
