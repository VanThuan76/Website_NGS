...
const ESVisionSection = ({ data, className }: Props) => {
  ...
  return (
    <section
      ...
      className={`relative max-w-[1440px] z-30 pb-4 md:pb-8 lg:pb-10 xl:pb-24 px-4 md:px-24 ${className}`}
      style={{
        background: `radial-gradient(50% 50% at 50% 50%, rgba(255, 186, 141, 0.35) 0%, rgba(255, 255, 255, 0.00) 100%)`,
      }}
    >
      <div className='w-full mx-auto my-auto flex flex-col lg:flex-row gap-5 justify-between items-center'>
