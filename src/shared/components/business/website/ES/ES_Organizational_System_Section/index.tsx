...
const ESOrganizationalSystemSection = ({ title, data, className }: Props) => {
  ...
  return (
    <section id={data.section.code} className={`pb-4 md:pb-8 lg:pb-16 xl:pb-24 px-4 md:px-24 ${className}`}>
      ...
      />
      <div className='max-w-[1440px] w-full h-full mx-auto my-auto md:mt-10 grid grid-cols-1 md:grid-cols-2 items-start justify-between md:gap-10 overflow-hidden'>
