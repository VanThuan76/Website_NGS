...
const ConnectUsSection = () => {
  ...
  return (
    <section id="ConnectUs" className='w-screen md:px-24 bg-[#FC5E03] dark:bg-[#5E18F4]'>
      <div className='max-w-[1440px] mx-auto my-auto p-2 md:p-4 lg:p-8 flex flex-col lg:flex-row gap-10 justify-between items-start rounded-md'>
