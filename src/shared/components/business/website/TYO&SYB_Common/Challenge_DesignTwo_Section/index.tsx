...
const ChallengeDesignTwoSection = ({ title, data, className }: Props) => {
  ...
  return (
    <section id={data.section.code} className={`w-screen overflow-hidden p-4 md:p-24 ${className} bg-[#051C2C]`}>
      ...
      />
      <div
        className='relative mt-14 min-h-[450px] w-full'
        style={{
      ...
      >
        {data.components.map((item, idx) => (
          <div key={idx} className='grid w-full grid-cols-3 items-start justify-start text-white'>
            <div
            ...
            <div className='col-span-2 w-full'>
              <div className='absolute top-0'>
                <div className='relative h-full w-full flex-shrink-0 snap-start'>
                  <div className='absolute left-1/3 top-1/2 z-30 flex h-full -translate-x-[40%] -translate-y-1/2 transform flex-col items-start justify-center text-white'>
