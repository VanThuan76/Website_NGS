  ...
  return (
    ...
    >
      <div className='mx-auto my-auto mt-10 flex max-w-[1440px] flex-col items-center justify-between'>
        ...
        <div className='mt-10 grid w-full grid-cols-2 items-center justify-between gap-24 md:grid-cols-4'>
          {data.components.map((item, idx) => (
            <div className='border-card-partner-designTwo-section col-span-1 h-[100px] w-full' key={idx}>
              <PreImage
                key={idx}
                src={item.image}
                layer={false}
