...
const HOOrganizationalSystemSection = ({ data, className }: Props) => {
  ...
  return (
    <section id={data && data.section && data.section.code} className={`relative w-screen pb-4 ${className}`}>
      <div className='mx-auto mt-20 flex h-full max-w-[1440px] flex-col items-center justify-center px-4 md:px-24'>
