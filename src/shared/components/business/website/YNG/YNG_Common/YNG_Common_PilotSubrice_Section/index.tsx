...
const YNGCommonPilotSubriceSection = ({ title, data, className }: Props) => {
  ...
  return (
    <section
      id="FormYNG"
      className={`w-full mb-4 md:mb-12 lg:mb-24 px-8 lg:px-24 ${className}`}
    >
      <div className='w-full mx-auto my-auto mt-10 flex flex-col justify-between items-center'>
        ...
        <div className={`w-full mt-5 grid grid-cols-1 md:grid-cols-2 justify-start items-start gap-16`}>
