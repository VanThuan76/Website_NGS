...
export const TYOchallenge2 = {
    section: {
        ...
        code: "TY1232323454",
        image: "",
        description: "Khi doanh nghiệp bắt tay vào quá trình tối ưu quy trình làm việc, doanh nghiệp thường phải đối mặt với nhiều thách thức. Theo báo cáo của Wall Street Journal, gần 70% các dự án cải tiến quy trình thất bại. Mặc dù vậy, việc tối ưu quy trình - nếu thành công, sẽ mang lại hiệu quả nhanh chóng cho doanh nghiệp. Với kinh nghiệm triển khai của NGS, có những thách thức phổ biến sau:"
    },
    components: [
        {
            id: 1,
