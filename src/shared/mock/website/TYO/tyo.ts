...
export const TYOOverview7_PG3_17 = {
  ...
  components: [
    ...
    },
    {
      ...
      title:
        'Đẩy nhanh quá trình triển khai bằng các phương pháp tối ưu nhất được đóng gói sẵn và phù hợp với doanh nghiệp của bạn.',
      description:
        'Đẩy nhanh quá trình triển khai bằng các phương pháp tối ưu nhất được đóng gói sẵn và phù hợp với doanh nghiệp của bạn.',
      slug: '',
      content: '',
  ...
  components: [
    {
      ...
      title: 'Phân tích trên công nghệ đám mây',
      description: '',
      slug: 'solution',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title: 'Xây dựng cơ sở dữ liệu đám mây',
      description: '',
      slug: 'solution',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title: 'Ứng dụng kho dữ liệu đám mây',
      description: '',
      slug: 'solution',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title: 'Quản trị dữ liệu thông minh trên nền tảng đám mây',
      description: '',
      slug: 'solution',
      content: '',
      image: '',
...
export const TYOOverview4_PG3_11 = {
  ...
  components: [
    ...
    },
    {
      ...
      slug: '',
      content:
        'Nếu không bị phát hiện, những kiểu tấn công này có thể tồn tại trong doanh nghiệp của bạn trong thời gian dài. Việc thực hiện đánh giá sự xâm nhập được chứng minh là một phương pháp có giá trị để đánh giá mức độ đầy đủ của các cơ chế phát hiện và ngăn chặn nó',
      image: '',
      video: '',
      thumbnail: '',
    },
    {
      ...
      description:
        'Cùng nhau làm việc như một doanh nghiệp, sử dụng AI để đưa ra quyết định chính xác hơn, tránh sai lầm, giảm thiểu rủi ro và đưa tính bền vững vào hoạt động hàng ngày.',
      slug: '',
      content: '',
      image: '/images/TYO_sec4.png',
      video: '',
    ...
    },
    {
      ...
      description:
        'Nắm rõ khả năng của đối tác, phối hợp để cung cấp đầy đủ và đúng thời hạn, đồng thời nhanh chóng tìm đối tác mới để xoay chuyển khi mọi thứ thay đổi.',
      slug: '',
      content: '',
      image: '/images/TYO_sec4.png',
      video: '',
...
export const TYOchallenge2_PG3_11 = {
  ...
  components: [
    ...
    },
    {
      ...
      slug: '',
      content:
        'Đáp ứng nhanh chóng với sự thay đổi của thị trường và nhu cầu của khách hàng bằng khả năng sản xuất các dịch vụ được quản lý và vận hành trên nền tảng đám mây thông minh để kiểm soát chi phí, cải thiện chất lượng và quản lý rủi ro',
      image: '/images/background_1.png',
      video: '',
      thumbnail: '',
    },
    {
      ...
      slug: '',
      content:
        'Xác định, phát triển, phân phối và quản lý các sản phẩm sáng tạo và bền vững bằng cách kết nối mọi khía cạnh của quá trình phát triển sản phẩm.',
      image: '/images/background_1.png',
      video: '',
      thumbnail: '',
    },
    {
      ...
      slug: '',
      content:
        'Theo dõi hiệu suất thiết bị, thực hiện bảo trì và dịch vụ cũng như tối đa hóa thời gian hoạt động bằng các công nghệ tiên tiến',
      image: '/images/background_1.png',
      video: '',
      thumbnail: '',
    },
...
export const TYOBanner1_PG3_15 = {
  section: {
    ...
    image: '/images/SME_banner.png',
    description:
      'NGS tự hào cung cấp bộ giải pháp cho các công ty vừa và nhỏ, giúp doanh nghiệp thúc đẩy bán hàng, nhanh chóng nhận diện và nắm bắt cơ hội kinh doanh với chi phí hợp lý!',
  },
  components: [],
};
...
export const TYOOverview1_PG3_15 = {
  section: {
    ...
    image: '',
    description:
      'NGS giúp quản lý toàn bộ doanh nghiệp của bạn bằng một giải pháp ERP tích hợp tất cả các tính năng trên một hệ thống với giá cạnh tranh – từ kế toán và tài chính, mua hàng, tồn kho, bán hàng và quan hệ khách hàng đến báo cáo và phân tích',
  },
  components: [],
};
...
export const TYOchallenge3_PG3_15 = {
  section: {
    id: 3,
    name: 'Bộ giải pháp của NGS dành cho doanh nghiệp SME',
    code: 'PG003.15SE00003',
    image: '/images/SME_s3.png',
    description: '',
  },
  components: [
    {
      ...
      title:
        'Cải thiện tỷ suất lợi nhuận, giảm sai sót và thúc đẩy việc ra quyết định có lợi hơn với bộ công cụ hoàn chỉnh để hợp lý hóa các hoạt động tài chính',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Giám sát toàn bộ quy trình bán hàng và vòng đời khách hàng hiệu quả hơn – từ liên hệ ban đầu đến lần bán hàng cuối cùng, dịch vụ sau bán hàng và hỗ trợ',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Tối ưu hóa các hoạt động mua hàng và kiểm soát chi phí bằng cách quản lý toàn bộ chu trình đặt hàng đến thanh toán bao gồm biên nhận, hóa đơn, hoàn trả và thanh toán',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Trao quyền cho nhân viên của bạn để đưa ra quyết định thông minh, tự tin nhanh hơn bằng cách nắm bắt tất cả thông tin quan trọng và cung cấp thông tin đó ngay lập tức trên toàn công ty',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Tận dụng các chức năng mở rộng dành riêng cho doanh nghiệp của bạn, các biện pháp thực hành tốt nhất và quy trình bằng các công cụ được thiết kế cho các doanh nghiệp vừa và nhỏ',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Với các ứng dụng dành cho thiết bị di động, bạn có thể truy cập ngay vào thông tin phù hợp nhất để giúp bạn điều hành doanh nghiệp của mình từ mọi nơi, mọi lúc',
      description: '',
      slug: '',
      content: '',
      image: '',
...
export const TYOBanner1_PG3_13 = {
  section: {
    ...
    image: '/images/SM_banner.png',
    description:
      'Tự động hóa quy trình chi tiêu và chủ động quản lý nhiều khoản chi tiêu hơn để kiểm soát tốt hơn, mang lại giá trị lớn hơn và tiết kiệm nhiều hơn',
  },
  components: [],
};
  ...
  components: [
    {
      ...
      description:
        'Đạt được cái nhìn thống nhất về chi tiêu trong công ty của bạn qua đó giảm chi phí, rủi ro, cải thiện hợp tác và đảm bảo mọi quyết định chi tiêu đều phù hợp với chiến lược kinh doanh, giúp thúc đẩy doanh nghiệp của bạn phát triển.',
      slug: '',
      content: '',
      image: '/images/card_key.png',
      video: '',
    ...
    },
    {
      ...
      description:
        'Triển khai các quy trình quản lý chi tiêu liền mạch trong từng danh mục chi tiêu, được tích hợp với các hệ thống phụ trợ, quy trình thanh toán và đối tác của bạn để mang lại khả năng hiển thị, kiểm soát và tiết kiệm tối ưu.',
      slug: '',
      content: '',
      image: '/images/card_key.png',
      video: '',
    ...
    },
    {
      ...
      description:
        'Giải quyết vấn đề kinh doanh bằng thu thập, phân tích và chia sẻ dữ liệu chi tiêu để đạt được mục tiêu tiết kiệm và lợi nhuận ròng nhanh chóng, giúp mở rộng quy mô và phát triển cùng công ty của bạn hôm nay và cả tương lai.',
      slug: '',
      content: '',
      image: '/images/card_key.png',
      video: '',
  ...
  components: [
    {
      ...
      title:
        'Tối ưu hóa chi phí đồng thời quản lý rủi ro và đảm bảo khoản tiết kiệm mà bạn thương lượng được hiện thực hóa bằng các giải pháp tìm nguồn cung ứng chiến lược.',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Tái tạo trải nghiệm mua hàng bằng cách kết nối các danh mục chi tiêu và tăng cường hợp tác với nhà cung cấp để thúc đẩy công việc nhanh hơn và chi tiêu tốt hơn.',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Quy trình thanh toán tự động giúp cắt giảm chi phí và rủi ro, đồng thời biến hóa đơn của bạn thành tài sản chiến lược.',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Quản lý vòng đời, hiệu suất và rủi ro ở một nơi để có được sản phẩm phù hợp từ đúng nhà cung cấp vào đúng thời điểm. Giải quyết các thách thức quản lý chi tiêu chi tiết bằng một phần mềm tích hợp cho toàn bộ quy trình chi tiêu từ nguồn cung cấp đến thanh toán.',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Thúc đẩy kết quả kinh doanh tốt hơn bằng một nền tảng duy nhất để tìm kiếm, gắn kết và quản lý lực lượng lao động bên ngoài toàn cầu của bạn.',
      description: '',
      slug: '',
      content: '',
      image: '',
    ...
    },
    {
      ...
      title:
        'Kết nối quản lý chi phí công tác, chi phí hoạt động kinh doanh và hóa đơn để có cái nhìn tổng thể và kiểm soát tốt hơn.',
      description: '',
      slug: '',
      content: '',
      image: '',
...
export const TYOBanner1_PG3_11 = {
  section: {
    ...
    image: '/images/SCM_banner.png',
    description:
      'Đưa các sản phẩm lấy khách hàng làm trung tâm ra thị trường nhanh hơn với chi phí thấp hơn bằng phần mềm và công cụ quản lý chuỗi cung ứng toàn cầu (SCM)',
  },
  components: [],
};
  ...
  components: [
    {
      ...
      description:
        'Chuỗi cung ứng đã thay đổi: Các giải pháp của NGS có thể giúp giảm thiểu rủi ro và thúc đẩy tăng trưởng bền vững trong quá trình thay đổi.',
      slug: '',
      content: '',
      image: '',
      video: '',
  ...
  components: [
    {
      ...
      title: 'Dịch vụ tốt nhất và chuyên biệt',
      description:
        'Dịch vụ tốt nhất & chuyên biệt: NGS có các chuyên gia tư vấn và giàu kinh nghiệm triển khai cho nhiều doanh nghiệp thuộc các lĩnh vực, ngành nghề khác nhau, đặc biệt là SAP tại Việt Nam. NGS đã xây dựng các gói sản phẩm riêng biệt đảm bảo triển khai nhanh chóng, dễ sử dụng',
      slug: '',
      content: '',
      image: '/images/card_key.png',
      video: '',
    ...
    },
    {
      ...
      title: 'Chi phí cạnh tranh',
      description:
        'Chi phí cạnh tranh: Với sự kết hợp giữa năng suất cao, chất lượng cao và giá cả cạnh tranh, chúng tôi mang lại giá trị vượt xa sự mong đợi của khách hàng',
      slug: '',
      content: '',
      image: '/images/card_key.png',
      video: '',
...
export const TYO_RF_Section2 = {
  section: {
    ...
    image: '',
    description:
      'Bạn đã sẵn sàng để đưa dự án của mình lên một tầm cao mới? Dịch vụ cung cấp Nhân lực của NGS giúp tăng cường năng lực đội ngũ và thúc đẩy sự thành công của dự án.',
  },
  components: [],
};
  ...
  components: [
    {
      ...
      content:
        'NGS cung cấp nguồn nhân lực chất lượng cao phù hợp với quy mô dự án của bạn. Với tiêu chí Linh Hoạt - Tốc Độ - Hiệu Quả, dịch vụ này nhằm giúp bạn tăng cường khả năng của đội phát triển của bạn với chi phí cạnh tranh nhất.',
      slug: '',
      description: '',
      image: '',
      video: '',
    ...
    },
    {
      ...
      content:
        'Với mỗi dự án, chúng tôi luôn đặt mình vào vị trí của bạn. Với các dự án dài hạn, NGS sẽ cung cấp các đội chuyên gia để tiếp nhận yêu cầu, lên kế hoạch và bàn giao những sản phẩm chất lượng trong đúng thời gian.',
      slug: '',
      description: '',
      image: '',
      video: '',
    ...
    },
    {
      ...
      content:
        'Xây dựng đội ngũ phát triển phần mềm của bạn ở nước ngoài nhằm giảm chi phí trong khi vẫn đảm bảo các sản phẩm được bàn giao có chất lượng cao và tích hợp liền mạch với tổ chức của bạn. Chúng tôi hướng đến việc nâng tầm chiến lược, tầm nhìn và doanh nghiệp của bạn.',
      slug: '',
      description: '',
      image: '',
      video: '',
...
export const TYO_CI_Section1 = {
  section: {
    ...
    image: '/images/TYO_CIsection1.png',
    description:
      ' Bạn đã sẵn sàng bắt đầu hành trình với giải pháp Bảo hiểm lõi thế hệ mới hướng tới Phần mềm dưới dạng dịch vụ chưa?',
  },
  components: [
    {
      id: 1,
