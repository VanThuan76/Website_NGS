  ...
  components: [
    {
      ...
      description:
        'Lập kế hoạch và phân tích mở rộng (xP&A) giúp bạn tập hợp con người và kế hoạch của mình lại với nhau để tăng tính linh hoạt và hiệu suất, bất kể sự kiện nào diễn ra. NGS hỗ trợ xP&A với sự tích hợp mượt mà giữa các gói dịch vụ và ứng dụng của bạn',
      slug: '',
      content: '',
      image: '/images/TYO_sec4.png',
      video: '',
    ...
    },
    {
      ...
      description:
        'Tăng tính linh hoạt và chính xác trong việc xử lý các dữ liệu động trong bối cảnh quy trình kinh doanh thay đổi nhanh chóng.Đẩy nhanh quá trình triển khai bằng các phương pháp tối ưu nhất và được đóng gói sẵn các chức năng cần thiết phù hợp với ngành kinh doanh của bạn',
      slug: '',
      content: '',
      image: '/images/TYO_sec4.png',
      video: '',
    ...
    },
    {
      ...
      description:
        'Tạo các kế hoạch phù hợp và tích hợp chặt chẽ với ứng dụng ERP và các ứng dụng khác.Tăng cường hợp tác giữa các nhóm làm việc',
      slug: '',
      content: '',
      image: '/images/TYO_sec4.png',
      video: '',
...

    {
      ...
      description:
        'Chuyển đổi nhanh chóng từ hiểu biết sâu sắc sang hành động bằng sự tích hợp giữa lập kế hoạch và phân tích.Tự động tạo kế hoạch từ các dự đoán và mô phỏng các kịch bản để có kết quả tốt hơn',
      slug: '',
      content: '',
      image: '/images/TYO_sec4.png',
      video: '',
...
export const TYOchallenge2_PG3_14 = {
  ...
  components: [
    ...
    },
    {
      ...
      slug: '',
      content:
        'Hỗ trợ nhân viên những thứ họ cần trong khi làm việc bất cư nơi đâu và bất cứ cách nào với các giải pháp toàn cầu về quản lý nhân sự lõi, tính lương, theo dõi thời gian, quản trị lợi ích, cung cấp dịch vụ nhân sự, v.v.',
      image: '/images/CoreValueHumanCapital.png',
      video: '',
      thumbnail: '',
    },
