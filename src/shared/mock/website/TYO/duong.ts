...
export const TYOOverview3_PG3_13 = {
    section: {
        ...
        image: "",
        description: "Quản lý tất cả các nguồn chi tiêu để tăng cường khả năng kiểm soát và khả năng phục hồi kinh doanh. Giải pháp của NGS giúp tối ưu hóa hoạt động mua sắm trực tiếp và gián tiếp, chi phí công tác và chi phí cho hoạt động kinh doanh, cũng như chi tiêu cho lực lượng lao động và các dịch vụ bên ngoài để có cái nhìn sâu sắc hơn về các vấn đề, kiểm soát và tiết kiệm tốt hơn."
...
export const TYOchallenge3_PG3_13 = {
    section: {
        ...
        description: "Lợi ích mà các doanh nghiệp có được thông qua giải pháp này là:- Tối ưu hóa chi phí, quản lý rủi ro và đảm bảo khoản tiết kiệm mà bạn thương lượng được hiện thực hóa bằng các giải pháp tìm nguồn cung ứng chiến lược.- Tái tạo trải nghiệm mua hàng bằng cách kết nối các danh mục chi tiêu và tăng cường hợp tác với nhà cung cấp để thúc đẩy công việc nhanh hơn và chi tiêu tốt hơn.- Tự động hóa quy trình thanh toán của bạn để giúp cắt giảm chi phí và rủi ro, đồng thời biến hóa đơn của bạn thành tài sản chiến lược."
    },
    components: [
    ]
}
...
export const TYOOverview1_PG3_11 = {
    section: {
        ...
        image: "",
        description: "Loại bỏ rủi ro ra khỏi chuỗi cung ứng doanh nghiệp trong quá trình từ thiết kế đến vận hành. Chuỗi cung ứng đã thay đổi: Các giải pháp của NGS có thể giúp giảm thiểu rủi ro và thúc đẩy tăng trưởng bền vững trong quá trình thay đổi."
