  ...
  components: [
    {
      ...
      description:
        'Trọn bộ ứng dụng quản lý quy trình bán hàng và tự động báo cáo kết quả kinh doanh trên cùng một hệ thống.',
      ...
      thumbnail: '',
      solutions: [
        'Quản lý khuyến mại & báo giá',
        'Quản lý khách hàng',
        'Quản lý hợp đồng',
        'Hệ thống POS',
        'Quản lý đại lý & bán sỉ',
  ...
  components: [
    {
      ...
      description:
        'Tích hợp các hệ thống hỗ trợ vận hành ngay trên nền tảng Quản lý doanh nghiệp như Tuyển dụng, ngân hàng, e-learning,...',
    ...
    },
    {
      ...
      description:
        'Tích hợp sử dụng các dịch vụ tiện ích ngay trong quy trình vận hành như: Dịch vụ vận chuyển, Chữ ký số, Sàn TMĐT,...',
