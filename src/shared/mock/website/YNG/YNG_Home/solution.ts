...
export const YNG_Home_Solution_ERP = {
    ...
    components: [
        ...
        },
        {
            ...
            slug: '/purchase-management, /inventory-management, /project-management, /production-management, /quality-management, /equipment-and-maintenance',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
        ...
        },
        {
            ...
            slug: '/receivable-accounting, /payable-accounting, /assets-and-tools, /stock-accounting, /general-accounting, /budget-management',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
    ...
    components: [
        {
            ...
            slug: '/promotion-management, /customer-management, /contract-management, /pos-system, /dealer-wholesale-management, /sales-team-management',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
        ...
        },
        {
            ...
            slug: '/crm-customer-relationship-management, /helpdesk-after-sale-care, /maintenance-warranty, /customer-surveys',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
    ...
    components: [
        {
            ...
            slug: '/organizational-chart, /assess',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
        ...
        },
        {
            ...
            slug: '/employee_profiles, /qlhd, /timekeeping, /vacation-overtime, /payroll, /tax-and-insurance',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
    ...
    components: [
        {
            ...
            slug: '/bank-connection, /recruitment-connection, /elearning-connection',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
        ...
        },
        {
            ...
            slug: '/e-sign, /e-commerce, /shipping-unit',
            content: '',
            image: '',
            video: '',
            thumbnail: '',
