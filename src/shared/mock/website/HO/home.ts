export const Home_1 = {
    ...
    components: [
        ...
        },
        {
            ...
            content: "MANG ĐẾN CHO KHÁCH HÀNG TRẢI NGHIỆM TỐT NHẤT VỚI NHỮNG SẢN PHẨM HOÀN THIỆN",
            image: "/images/HO_Banner.png",
            video: "",
            thumbnail: ""
        },
        {
            ...
            content: "CHUYỂN ĐỔI SỐ KHÔNG CHỈ LÀ CÔNG NGHỆ , ĐÓ LÀ CON NGƯỜI",
            image: "/images/HO_Banner.png",
            video: "",
            thumbnail: ""
        },
        {
            ...
            content: "ĐỒNG HÀNH TRONG HÀNH TRÌNH PHÁT TRIỂN THÀNH CÔNG CỦA KHÁCH HÀNG",
            image: "/images/HO_Banner.png",
            video: "",
            thumbnail: ""
        }
...
export const Home_3 = {
    section: {
        id: 3,
        name: 'Chuyển đổi tổ chức của bạn lên phiên bản 5.0 bằng dịch vụ công nghệ thông tin tổng thể từ tư vấn đến hỗ trợ vận hành',
        code: "PG001SE00003",
        image: "/images/PG001SE00003CN000001.png",
        description: "Quá trình chuyển đổi số chưa bao giờ dễ dàng đối với bất kỳ doanh nghiệp nào. NGS cam kết đồng hành cùng mọi tổ chức trong quá trình chuyển đổi với đội ngũ chuyên gia tư vấn, thiết kế, triển khai,và vận hành giải pháp chuyên nghiệp, đồng thời dựa trên sự hiểu biết sâu sắc về đặc thù của mỗi ngành"
    },
    components: [
        {
            id: 1,
...
export const Home_5 = {
    section: {
        id: 5,
        name: 'Tiên phong đào tạo thực hành',
        code: "PG001SE00005",
        image: "/images/ho_se5.png",
        description: "Trường Cao đẳng an ninh mạng iSPACE là đơn vị tiên phong trong đào tạo thực hành từ năm 2008 theo tiêu chí tuyển sinh đi liền tuyển dụng"
    },
    components: [
    ]
}
    ...
    components: [
        {
            ...
            description: "- NGS sở hữu đội ngũ chuyên gia công nghệ, tư vấn, triển khai và vận hành giải pháp Công nghệ thông tin và An ninh mạng của các hãng hàng đầu. Bên cạnh đó là sự hiểu biết đa lĩnh vực từ Tài chính ngân hàng, Hàng không, Dầu khí, Sản xuất, Thương mại .... // - Đồng thời, các giải pháp do NGS phát triển được xây dựng trên các nền tảng open source hiện tại và sự hiểu biết sâu sắc về hệ thống quản trị của mỗi ngành",
            slug: "sang-tao-27",
            content: "",
            image: "",
            video: "",
        ...
        },
        {
            ...
            description: "NGS mong muốn mang lại sự hài lòng cho khách hàng trong suốt hành trình dịch vụ, sản phẩm của NGS thông qua quy trình chuyên nghiệp, sự hiểu biết sâu sắc về nhu cầu và mong đợi của quý khách hàng cũng như thái độ phụng sự hết lòng",
            slug: "linh-hoat-28",
            content: "",
            image: "",
            video: "",
        ...
        },
        {
            ...
            description: "NGS nuôi dưỡng văn hóa sáng tạo, đổi mới liên tục bên trong tổ chức của mình, để từ đó xây dựng nên một đội ngũ nhân sự chuyên nghiệp mà linh hoạt. Chúng tôi tin rằng, sự sáng tạo sẽ góp phần tạo ra các giải pháp, phương án triển khai tốt nhất cho nhu cầu của khách hàng",
            slug: "sang-tao-29",
            content: "",
            image: "",
            video: "",
