...
export const Home_3 = {
    section: {
        id: 3,
        name: 'CẬP NHẬT PHIÊN BẢN 5.0// CHO TỔ CHỨC CỦA BẠN// BẰNG DỊCH VỤ CÔNG NGHỆ THÔNG TIN// TỔNG THỂ TỪ TƯ VẤN ĐẾN VẬN HÀNH',
        code: "PG001SE00003",
        image: "/images/PG001SE00003CN000001.png",
        description: "Quá trình chuyển đổi số chưa bao giờ dễ dàng đối với bất kỳ doanh nghiệp nào. NGS cam kết đồng hành cùng quá trình đó với mọi tổ chức bằng đội ngũ chuyên gia tư vấn hàng đầu, thiết kế, triển khai, và vận hành giải pháp chuyên nghiệp. Bên cạnh đó chúng tôi mang đến sự hiểu biết sâu sắc về đặc thù của ngành để hỗ trợ tốt nhất cho khách hàng."
    },
    components: [
        {
            id: 1,
