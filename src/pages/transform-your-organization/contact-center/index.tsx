...
import { TYOClientStories2, TYOService2, TYO_CC_Banner, TYO_CC_Section2, TYO_CC_Section3, TYO_CC_Section4, TYO_DSP_Section3, TYO_DSP_Section4 } from '@/mocks/website/TYO/overview';
