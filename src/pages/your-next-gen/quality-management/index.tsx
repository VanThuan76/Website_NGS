...
const QMDetailPage = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Quản lý chất lượng NGS</title>
        <meta name='description' content='Quản lý chất lượng NGS' />
        <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
      </Head>
      <YNGDetailBannerSection data={YNGDetailBanner1} />
      <YNGDetailWhyChooseSection title='Tại sao chọn Quản lý chất lượng?' data={YNG_QM_Section2} />
      <YNGDetailProductSection data={YNG_QM_Section3} />
...
QMDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default QMDetailPage;
