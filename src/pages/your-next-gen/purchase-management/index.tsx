...
import { YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8, YNG_PM_Banner, YNG_PM_Section2, YNG_PM_Section3 } from '@/mocks/website/YNG/yng';
...
const PMDetailPage = () => {
  return (
    <React.Fragment>
      ...
      <ScrollRevealWrapper  >
        <YNGDetailBannerSection data={YNG_PM_Banner} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
