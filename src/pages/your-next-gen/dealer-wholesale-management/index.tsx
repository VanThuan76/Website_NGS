...
import { YNG_DWM_Banner, YNG_DWM_Section2, YNG_DWM_Section3, YNG_DWM_Section4, YNG_DWM_Section5, YNG_DWM_Section6, YNG_DWM_Section7, YNG_DWM_Section8 } from '@/mocks/website/YNG/yng';
...
const DWMDetailPage = () => {
  return (
    <React.Fragment>
      ...
      <ScrollRevealWrapper  >
        <YNGDetailBannerSection data={YNG_DWM_Banner} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
