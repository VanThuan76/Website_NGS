...
import { YNG_MNS_Section2, YNG_MNS_Section3, YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8 } from '@/mocks/website/TYO/thuy_yng';
import { YNG_DWM_Section2, YNG_DWM_Section3, YNG_DWM_Section4, YNG_DWM_Section5, YNG_DWM_Section6, YNG_DWM_Section7, YNG_DWM_Section8 } from '@/mocks/website/TYO/duong_yng';
...
const DWMDetailPage = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Quản lý đại lý & bán sỉ</title>
        <meta name='description' content='Quản lý đại lý & bán sỉ' />
        <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
      </Head>
      <YNGDetailBannerSection data={YNGDetailBanner1} />
      <YNGDetailWhyChooseSection title='Tại sao chọn Quản lý đại lý & bán sỉ?' data={YNG_DWM_Section2} />
      <YNGDetailProductSection data={YNG_DWM_Section3} />
...
DWMDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default DWMDetailPage;
