...
import { YNG_ES_Banner, YNG_ES_Section2, YNG_ES_Section3, YNG_ES_Section4, YNG_ES_Section5, YNG_ES_Section6, YNG_ES_Section7, YNG_ES_Section8 } from '@/mocks/website/YNG/yng';
...
const ESDetailPage = () => (
  <React.Fragment>
    <Head>
      ...
      <meta name='description' content='Chữ ký số' />
      <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
    </Head>
    <ScrollRevealWrapper  >
      <YNGDetailBannerSection data={YNG_ES_Banner} />
    </ScrollRevealWrapper>
    <ScrollRevealWrapper  >
      <YNGDetailWhyChooseSection title='Tại sao chọn Chữ ký số?' data={YNG_ES_Section2} />
    </ScrollRevealWrapper>
    <ScrollRevealWrapper  >
      <YNGDetailProductSection data={YNG_ES_Section3} />
    </ScrollRevealWrapper>
    <ScrollRevealWrapper  >
    ...
    <ScrollRevealWrapper  >
      <YNGCommonBackSolutionSection title='Ứng dụng liên quan' data={YNG_ES_Section7} />
    </ScrollRevealWrapper>
    <ScrollRevealWrapper  >
      <YNGCommonPilotSubriceSection title='Đăng ký tư vấn hoặc Demo' data={YNG_ES_Section8} />
    </ScrollRevealWrapper>
  </React.Fragment>
);

ESDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default ESDetailPage;
