...
import { YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8, YNG_PNA_Banner, YNG_PNA_Section2, YNG_PNA_Section3 } from '@/mocks/website/YNG/yng';
...
const PNADetailPage = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Đề xuất & Phê duyệt NGS</title>
        <meta name='description' content='Đề xuất & Phê duyệt NGS' />
        <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
      </Head>
      <ScrollRevealWrapper  >
        <YNGDetailBannerSection data={YNG_PNA_Banner} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
        <YNGDetailWhyChooseSection title='Tại sao chọn Đề xuất & Phê duyệt?' data={YNG_PNA_Section2} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
        <YNGDetailProductSection data={YNG_PNA_Section3} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
...
PNADetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default PNADetailPage;
