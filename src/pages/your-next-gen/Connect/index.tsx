...
import { YNG_Home_Solution_Connect } from '@/mocks/website/YNG/YNG_Home/solution';
import { YNGHomeBannerConnect } from '@/mocks/website/YNG/YNG_Home/example';
...
const ERPPage = () => {
  return (
    <React.Fragment>
      ...
      <YNGHomeBannerSection title='ERP CONNECT' data={YNGHomeBannerConnect} />
      <YNGHomeSolutionSection data={YNG_Home_Solution_Connect} />
