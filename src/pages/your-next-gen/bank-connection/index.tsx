...
import { YNG_BC_Banner, YNG_BC_Section2, YNG_BC_Section3, YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8 } from '@/mocks/website/YNG/yng';
...
const BCDetailPage = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Kết nối ngân hàng NGS</title>
        <meta name='description' content='Kết nối ngân hàng NGS' />
        <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
      </Head>
      <ScrollRevealWrapper  >
        <YNGDetailBannerSection data={YNG_BC_Banner} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
        <YNGDetailWhyChooseSection title='Tại sao chọn Kết nối ngân hàng?' data={YNG_BC_Section2} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
        <YNGDetailProductSection data={YNG_BC_Section3} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
...
BCDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
