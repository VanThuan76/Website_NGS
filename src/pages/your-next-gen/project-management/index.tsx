...
import { YNG_AM_Section2, YNG_AM_Section3, YNG_DM_Section2, YNG_DM_Section3, YNG_EL_Section2, YNG_EL_Section3, YNG_IM_Section2, YNG_IM_Section3, YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8, YNG_PM_Section2, YNG_PM_Section3, YNG_ProM_Section2, YNG_ProM_Section3 } from '@/mocks/website/TYO/thuy_yng';

const ScrollRevealWrapper = dynamic(() => import('@/components/common/customization/ScrollRevealWrapper'), {
  ssr: false,
});
const ProMDetailPage = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Quản lý dự án NGS</title>
        <meta name='description' content='Quản lý dự án NGS' />
        <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
      </Head>
      <YNGDetailBannerSection data={YNGDetailBanner1} />
      <YNGDetailWhyChooseSection title='Tại sao chọn Quản lý dự án?' data={YNG_ProM_Section2} />
      <YNGDetailProductSection data={YNG_ProM_Section3} />
...
ProMDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default ProMDetailPage;
