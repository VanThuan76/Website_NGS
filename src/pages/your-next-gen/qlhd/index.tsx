...
import { YNG_QLHD_Banner, YNG_QLHD_Section2, YNG_QLHD_Section3, YNG_QLHD_Section4, YNG_QLHD_Section5, YNG_QLHD_Section6, YNG_QLHD_Section7, YNG_QLHD_Section8 } from '@/mocks/website/YNG/yng';
...
const QLHDDetailPage = () => (
  <React.Fragment>
    ...
    <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
      <YNGCommonBackSolutionSection title='Back to Solution' data={YNG_QLHD_Section7} />
    </ScrollRevealWrapper>
    <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
      <YNGCommonPilotSubriceSection title='Pilot Subcribe' data={YNG_QLHD_Section8} />
    </ScrollRevealWrapper>
  </React.Fragment>
);
