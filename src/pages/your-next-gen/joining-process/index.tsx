...
import { YNG_JC_Banner, YNG_JC_Section2, YNG_JC_Section3, YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8 } from '@/mocks/website/YNG/yng';
...
const JCDetailPage = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Quy trình gia nhập NGS</title>
        <meta name='description' content='Quy trình gia nhập NGS' />
        <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
      </Head>
      <ScrollRevealWrapper  >
        <YNGDetailBannerSection data={YNG_JC_Banner} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
        <YNGDetailWhyChooseSection title='Tại sao chọn Quy trình gia nhập?' data={YNG_JC_Section2} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
        <YNGDetailProductSection data={YNG_JC_Section3} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper  >
...
JCDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default JCDetailPage;
