...
import { YNG_CCRM_Banner, YNG_CCRM_Section2, YNG_CCRM_Section3, YNG_CCRM_Section4, YNG_CCRM_Section5, YNG_CCRM_Section6, YNG_CCRM_Section7, YNG_CCRM_Section8 } from '@/mocks/website/YNG/yng';
...
const CCRMDetailPage = () => {
  return (
    <React.Fragment>
      ...
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
        <YNGDetailWhyChooseSection title='Tại sao chọn Odoo CRM?' data={YNG_CCRM_Section2} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
