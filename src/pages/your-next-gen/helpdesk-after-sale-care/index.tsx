...
import { YNG_HASC_Banner, YNG_HASC_Section2, YNG_HASC_Section3, YNG_HASC_Section4, YNG_HASC_Section5, YNG_HASC_Section6, YNG_HASC_Section7, YNG_HASC_Section8 } from '@/mocks/website/YNG/yng';
  ...
  return (
    <React.Fragment>
      ...
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
        <YNGDetailBannerSection data={YNG_HASC_Banner} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
      ...
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
        <YNGCommonBackSolutionSection title='Ứng dụng liên quan' data={YNG_HASC_Section7} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
        <YNGCommonPilotSubriceSection title='Đăng ký tư vấn hoặc Demo' data={YNG_HASC_Section8} />
      </ScrollRevealWrapper>
    </React.Fragment>
  );
};
