...
import { YNG_VO_Banner, YNG_VO_Section2, YNG_VO_Section3, YNG_VO_Section4, YNG_VO_Section5, YNG_VO_Section6, YNG_VO_Section7, YNG_VO_Section8 } from '@/mocks/website/YNG/yng';
...
const VODetailPage = () => (
  <React.Fragment>
    ...
    <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
      <YNGDetailBannerSection data={YNG_VO_Banner} />
    </ScrollRevealWrapper>
    <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
    ...
    <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
      <YNGCommonBackSolutionSection title='Ứng dụng liên quan' data={YNG_VO_Section7} />
    </ScrollRevealWrapper>
    <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
      <YNGCommonPilotSubriceSection title='Đăng ký tư vấn hoặc Demo' data={YNG_VO_Section8} />
    </ScrollRevealWrapper>
  </React.Fragment>
);
