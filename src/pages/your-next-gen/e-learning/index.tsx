...
import { YNG_AM_Section2, YNG_AM_Section3, YNG_DM_Section2, YNG_DM_Section3, YNG_EL_Section2, YNG_EL_Section3, YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8 } from '@/mocks/website/TYO/thuy_yng';
...
ELDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default ELDetailPage;
