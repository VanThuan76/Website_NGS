...
import { YNG_ENM_Banner, YNG_ENM_Section2, YNG_ENM_Section3, YNG_MNS_Banner, YNG_MNS_Section2, YNG_MNS_Section3, YNG_MNS_Section4, YNG_MNS_Section5, YNG_MNS_Section6, YNG_MNS_Section7, YNG_MNS_Section8, YNG_PNA_Section2, YNG_PNA_Section3 } from '@/mocks/website/YNG/yng';
...
const ENMDetailPage = () => {
  return (
    <React.Fragment>
      <Head>
        <title>Thiết bị và Bảo dưỡng NGS</title>
        <meta name='description' content='Thiết bị và Bảo dưỡng NGS' />
        <meta name='keywords' content='Công nghệ thông tin, Giải pháp số' />
      </Head>
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
        <YNGDetailBannerSection data={YNG_ENM_Banner} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
        <YNGDetailWhyChooseSection title='Tại sao chọn Thiết bị và Bảo dưỡng?' data={YNG_ENM_Section2} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
        <YNGDetailProductSection data={YNG_ENM_Section3} />
      </ScrollRevealWrapper>
      <ScrollRevealWrapper revealConfig={{ origin: 'left', distance: '30px', duration: 1000 }} >
...
ENMDetailPage.getLayout = (children: React.ReactNode) => <LayoutWebsite>{children}</LayoutWebsite>;
export default ENMDetailPage;
