...
import { SYB_MA_Section1, SYB_MA_Section2, SYB_MA_Section3, SYB_MA_Section4, SYB_MA_Section5, SYB_MA_Section6, SYB_MA_Section7, SYB_MA_Section8, SYB_OIS_Section1, SYB_OIS_Section2, SYB_OIS_Section3, SYB_OIS_Section4, SYB_OIS_Section5, SYB_OIS_Section6, SYB_OIS_Section7, SYB_OIS_Section8 } from '@/mocks/website/SYB/trang';
...
const ERPPage = () => {
  return (
    <React.Fragment>
      ...
      <BannerDesignTwoSection breadcrumb={["Trang chủ", "Dịch vụ xuất sắc", "Dịch vụ kiểm thử đăng nhập hệ thống"]} data={SYB_OIS_Section1}/>
