...
import { SYB_TI_Banner, SYB_TI_Section2, SYB_TI_Section4, SYB_TI_Section5, SYB_TI_Section6, SYB_TI_Section8 } from '@/mocks/website/TYO/thuy_syb';
...
const TIPage = () => {
  return (
    <React.Fragment>
      ...
      <BannerDesignOneSection title="Develop new solution" data={SYB_TI_Banner}/>
      <OverviewDesignFiveSection title='Tổng quan' data={SYB_TI_Section2}/>
      <ServiceDesignThreeSection title='Dịch vụ' data={SYB_TI_Section4} />
